	...
	return (
		<div>
			<div className="w-screen h-[100vh] flex">
				<div id="menu-container" className="bg-[#0d4641] w-96 h-full select-none overflow-auto">
					<div className="grid grid-cols-2 gap-3 p-3">
						...
						<div className="col-span-2">
							<div className="text-white text-2xl p-5 text-center">Total Detected Dark Activities By FSM</div>
							<div className="overflow-y-auto h-[25rem] space-y-2">
								{vessels.total_dark_activity_vessels_fsm.map((x, i) => {
									return (
						...
						<div className="col-span-2">
							<div className="text-white text-2xl p-5 text-center">Total Detected Dark Activities By ML</div>
							<div className="overflow-y-auto h-[25rem] space-y-2">
								{vessels.total_dark_activity_vessels_ml.map((x, i) => {
									return (
										<div key={i} className="bg-emerald-800 p-3 mx-2 rounded-md">
											<VesselCard vessel={x} />
										</div>
				...
				<div id="menu-container" className="bg-[#0d4641] w-96 h-full select-none flex flex-col overflow-auto">
					<div className="grid grid-cols-2 gap-3 p-3">
						<div className="col-span-2">
						...
						<div className="col-span-2">
							...
							<div className="overflow-y-auto space-y-2 h-[25rem]">
						...
						<div className="col-span-2">
							<div className="text-white text-2xl p-5 text-center">Detected Dark Activities By FSM</div>
							<div className="overflow-y-auto space-y-2 h-[25rem]">
								{vessels.range_check.detected_dark_activity_vessels_by_fsm.map((x, i) => {
									return (
										<div key={i} className="bg-emerald-800 p-3 mx-2 rounded-md">
											<VesselCard vessel={x} />
										</div>
						...
						<div className="col-span-2">
							<div className="text-white text-2xl p-5 text-center">Detected Dark Activities By ML</div>
							<div className="overflow-y-auto space-y-2 h-[25rem]">
								{vessels.range_check.detected_dark_activity_vessels_by_ml.map((x, i) => {
									return (
										<div key={i} className="bg-emerald-800 p-3 mx-2 rounded-md">
											<VesselCard vessel={x} />
										</div>
						...
						<div className="col-span-2">
							<div className="text-white text-2xl p-5 text-center">Nearby Dark Activity Vessels</div>
							<div className="overflow-y-auto space-y-2 h-[25rem]">
